...
set "_NOCD= init add create import list ls info show open cursor cur code co antigravity anti ag windsurf wind ws codium vscodium sourcegit sgit sg chatgpt cgpt codex droid factory cmux cm wmux wm ss superset supersetsh claude cowork claudecode ccode t3 t3code remove rm delete del unregister unreg edit rename ren workspace copy color sync clean host self agent install update reload skill sbx help version run connect conn ssh -h --help --version -v "
