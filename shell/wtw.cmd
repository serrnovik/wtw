...
set "_NOCD= init add create list ls open cursor cur code co antigravity anti ag windsurf wind ws codium vscodium sourcegit sgit sg codex claude cowork claudecode ccode t3 t3code remove rm delete del unregister unreg workspace copy color sync clean install update skill sbx help -h --help "
