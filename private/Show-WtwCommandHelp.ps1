function Show-WtwCommandHelp {
    ...
    $help = switch ($Command) {
        'init'        { @('wtw init [aliases...]', 'Register current repo with wtw.', '', 'Options:', '  --template <alias>  Share workspace settings from another repo') }
